...
const CharacterCard: React.FC<CharacterCardProps> = (
    {name, species, status, image, onCardClick}) => {
    ...
    return (
        ...
        "
            ...
            relative overflow-hidden">
                ...
                from-gray-900/80 to-transparent opacity-0
                group-hover:opacity-100 transition-opacity
            "></div>
                <div className="p-5">
                    <h3 className="
                    text-xl font-bold text-green-400 mb-2
                    ...
                    <span className={
                        `text-sm font-semibold ${getStatusColor(status)}`}
                    >
                        Status:
                    <span className=
